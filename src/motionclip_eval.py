...
def evaluate(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    all_metrics = {}
    replication_times = cfg.model.replicate_times
    for i in range(replication_times):
        log.info(f"Evaluating MotionCLIP - Replication {i}")
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="eval_motionclip.yaml")
